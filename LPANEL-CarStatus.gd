...
func _process(_delta):
	...
	if serial_data.red_led == 0 and serial_data.green_led == 0 and serial_data.battery_voltage > 6:
		...
		$MarginContainer/VBoxContainer/CarStatus/OverallStatus/Status.add_theme_color_override("font_color",Color("36c21b")) #green
		...
		$MarginContainer/VBoxContainer/CarStatus/OverallStatus/Status.add_theme_color_override("font_color",Color("c21b1b")) #green
	...
	if serial_data.red_led_flashing and serial_data.green_led == 0:
		...
		$MarginContainer/VBoxContainer/CarStatus/ConnectionBox/ConnectionStatus.add_theme_color_override("font_color",Color("c21b1b")) #red
		...
		$MarginContainer/VBoxContainer/CarStatus/ConnectionBox/ConnectionStatus.add_theme_color_override("font_color",Color("b9c21b")) #yellow
		...
		$MarginContainer/VBoxContainer/CarStatus/ConnectionBox/ConnectionStatus.add_theme_color_override("font_color",Color("36c21b")) #green
	elif serial_data.red_led == 1 and serial_data.green_led == 0:
		...
		$MarginContainer/VBoxContainer/CarStatus/ConnectionBox/ConnectionStatus.add_theme_color_override("font_color",Color("6d000000")) #red
	else:
	...
	if serial_data.connected:
		...
		if serial_data.red_led == 0:
			...
			$MarginContainer/VBoxContainer/CarStatus/RedLEDBox/RedLEDStatus.add_theme_color_override("font_color",Color("6d000000")) #grey
		elif serial_data.red_led == 1:
			$MarginContainer/VBoxContainer/CarStatus/RedLEDBox/RedLEDStatus.text = "Showing"
			$MarginContainer/VBoxContainer/CarStatus/RedLEDBox/RedLEDStatus.add_theme_color_override("font_color",Color("c21b1b")) #red
		else:
		...
		if serial_data.green_led == 0:
			...
			$MarginContainer/VBoxContainer/CarStatus/GreenLEDBox/GreenLEDStatus.add_theme_color_override("font_color",Color("c21b1b")) #red
		elif serial_data.green_led == 1:
			$MarginContainer/VBoxContainer/CarStatus/GreenLEDBox/GreenLEDStatus.text = "Showing"
			$MarginContainer/VBoxContainer/CarStatus/GreenLEDBox/GreenLEDStatus.add_theme_color_override("font_color",Color("36c21b")) #green
		else:
		...
		#green
		$MarginContainer/VBoxContainer/CarStatus/GreenLEDBox/GreenLEDStatus.text = "Offline"
		$MarginContainer/VBoxContainer/CarStatus/GreenLEDBox/GreenLEDStatus.add_theme_color_override("font_color",Color("6d000000")) #grey
